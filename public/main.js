...
const inputTodoEl = document.getElementById("input_el");
...
function renderTodos() {
    // Update header and navigation counts
    updateNavCount();
    updateHeaderText();
            ...
            return `
                <div class="card todo-item">
                    ...
                    <div class="todo-buttons">
                        <button class="todo-actions-btn" onclick="updateTodo(${todo.id})" ${
                todo.completed ? "disabled" : ""
            }>
                            <h6>Done</h6>
                        </button>
                        <button class="todo-actions-btn" onclick="deleteTodo(${todo.id})">
                            <h6>Delete</h6>
                        </button>
                    </div>
                </div>
    ...
    // Render input container and task list in the correct order
    main.innerHTML = inputContainer + taskList;
